      ...
      spec {
        ...
        volume {
          ...
          persistent_volume_claim {
            claim_name = kubernetes_persistent_volume_claim.jenkins_blue_pvc.metadata[0].name
          }
        }
      }
    }
    ...
    template {
      ...
      spec {
        ...
        volume {
          name = "jenkins-home"
          persistent_volume_claim {
            claim_name = kubernetes_persistent_volume_claim.jenkins_green_pvc.metadata[0].name
          }
        }
      }
    }
